...
namespace starkov.Faker.Server
{
  public class ModuleFunctions
  {
    ...
    [Remote]
    public virtual void CreateAsyncForGenerateEntities(int count, int databookId, int userId)
    {
    ...
    /// <param name="userId">ИД пользователя, которому будет отправлено уведомление.</param>
    [Remote]
    public virtual void CreateAndExecuteAsyncHandlers(int count, int databookId, int userId)
    {
